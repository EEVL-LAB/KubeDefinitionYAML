...
helm.sh/chart: {{ include "tokenizer.chart" . }}
...
*/}}
{{- define "tokenizer.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "tokenizer.fullname" .) .Values.serviceAccount.name }}
{{- else }}
